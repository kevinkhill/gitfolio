...
function readCacheFile() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs_1["default"].promises.readFile(exports.cacheFilepath, "utf8")];
                case 1:
                    contents = _a.sent();
...
function writeCacheFile(cache) {
    return __awaiter(this, void 0, void 0, function () {
        var cacheContents;
        return __generator(this, function (_a) {
            cacheContents = JSON.stringify(cache, null, 2);
            return [2 /*return*/, fs_1["default"].promises.writeFile(exports.cacheFilepath, cacheContents)];
        });
    });
}
